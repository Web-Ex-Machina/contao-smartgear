...
sed -i -E "s~(.*)\"@fortawesome/fontawesome-free\": \"(.*)\",(.*)~\1\3~g" package.json
sed -i -E "s~(.*)\"@fortawesome/fontawesome-pro\": \"(.*)\",(.*)~\1\3~g" package.json
sed -i -E "s~(.*)\"@fortawesome/free-brands-svg-icons\": \"(.*)\",(.*)~\1\3~g" package.json
sed -i -E "s~(.*)\"@fortawesome/free-regular-svg-icons\": \"(.*)\",(.*)~\1\3~g" package.json
sed -i -E "s~(.*)\"@fortawesome/free-solid-svg-icons\": \"(.*)\",(.*)~\1\3~g" package.json
