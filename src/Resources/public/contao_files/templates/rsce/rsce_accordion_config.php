...
return [
    'label' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion'], 'contentCategory' => 'accordion', 'standardFields' => ['cssID'], 'fields' => [
        'config_legend' => [
            ...
            'label' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion']['disable_collapse'], 'inputType' => 'checkbox', 'eval' => ['tl_class' => 'w50'],
        ], 'auto_collapse' => [
            'label' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion']['auto_collapse'], 'inputType' => 'checkbox', 'eval' => ['tl_class' => 'w50'],
        ]

        // Items
        , 'items' => [
            'label' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion']['items_legend'], 'elementLabel' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion']['item_legend'], 'inputType' => 'list', 'fields' => [
                // Content
                'title' => [
                    'label' => &$GLOBALS['TL_LANG']['tl_content']['headline'], 'inputType' => 'text', 'eval' => ['tl_class' => 'w50', 'mandatory' => true],
                ], 'hl_title' => [
                    'label' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion']['hl_title'],
                    'inputType' => 'select',
                    'options' => [
                        '' => &$GLOBALS['TL_LANG']['tl_content']['rsce_accordion']['hl_title']['option_none'],
                        'h1' => 'H1',
                        'h2' => 'H2',
                        'h3' => 'H3',
                        'h4' => 'H4',
