...
return [
    'label' => &$GLOBALS['TL_LANG']['tl_content']['rsce_hero'], 'contentCategory' => 'banner', 'standardFields' => ['cssID'], 'fields' => [
        ...
        'overlay_background' => [
            ...
            'inputType' => 'select',
            'options_callback' => static fn($dc): string|array|false => \WEM\SmartgearBundle\Classes\Util::getSmartgearColors($dc->table, (int) $dc->id, 'rsce'),
        ...
        'title_modifier' => [
            ...
            'options_callback' => static fn(): array => [
                'title--1' => $GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'] ? sprintf($GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'], '1') : '1',
                'title--2' => $GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'] ? sprintf($GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'], '2') : '2',
                'title--3' => $GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'] ? sprintf($GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'], '3') : '3',
                'title--4' => $GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'] ? sprintf($GLOBALS['TL_LANG']['tl_content']['title_modifier']['option'], '4') : '4',
            ],
