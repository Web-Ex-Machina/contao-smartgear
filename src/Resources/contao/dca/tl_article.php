...
(new DcaLoader('tl_article'))->load();

DCAManipulator::create('tl_article')
    ->addField('update_reminder', [
        'label' => &$GLOBALS['TL_LANG']['WEMSG']['DCA']['update_reminder'],
        'inputType' => 'checkbox',
        'eval' => ['submitOnChange' => true, 'tl_class' => 'clr m12  jkergjnkergklergjnklergjnklergergnkgjnklernklrgenklj'],
...
foreach ($GLOBALS['TL_DCA']['tl_article']['palettes'] as $paletteName => $paletteConfig) {
