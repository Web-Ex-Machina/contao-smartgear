...
class Tinymce extends Block implements BlockInterface
{
    ...
    public function install()
    {
        try {
            ...
            return [
                'toastr' => $this->callback('toastr', ['success', 'La configuration TinyMCE a été importée avec succès.']), 'callbacks' => [$this->callback('refreshBlock')],
            ];
        } catch (Exception $e) {
            $this->remove();
            throw $e;
    ...
    public function remove()
    {
        try {
            ...
            // And return an explicit status with some instructions
            return [
                'toastr' => $this->callback('toastr', ['success', 'La désinstallation de la configuration TinyMCE a été effectuée avec succès.']), 'callbacks' => [$this->callback('refreshBlock')],
            ];
        } catch (Exception $e) {
            throw $e;
        }
