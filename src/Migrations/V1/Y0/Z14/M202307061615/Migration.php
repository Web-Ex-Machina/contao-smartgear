...
{
    protected $name = 'Smargear update to v1.0.14';
    protected $description = 'Set Smartgear to version 1.0.14';
    protected $version = '1.0.14';
    protected $translation_key = 'WEMSG.MIGRATIONS.V1_0_14_M202307061615';
