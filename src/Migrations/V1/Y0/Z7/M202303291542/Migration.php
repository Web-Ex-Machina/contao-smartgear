...
{
    protected string $name = 'Smargear update to v1.0.7';

    protected string $description = 'Set Smartgear to version 1.0.7';

    protected string $version = '1.0.7';

    protected string $translation_key = 'WEMSG.MIGRATIONS.V1_0_7_M202303291542';
