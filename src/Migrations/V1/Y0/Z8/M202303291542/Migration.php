...
namespace WEM\SmartgearBundle\Migrations\V1\Y0\Z8\M202303291542;
...
{
    protected string $name = 'Smargear update to v1.0.8';

    protected string $description = 'Set Smartgear to version 1.0.8';

    protected string $version = '1.0.8';

    protected string $translation_key = 'WEMSG.MIGRATIONS.V1_0_8_M202303291542';
