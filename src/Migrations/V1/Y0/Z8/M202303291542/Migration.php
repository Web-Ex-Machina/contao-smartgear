...
{
    protected $name = 'Smargear update to v1.0.8';
    protected $description = 'Set Smartgear to version 1.0.8';
    protected $version = '1.0.8';
    protected $translation_key = 'WEMSG.MIGRATIONS.V1_0_8_M202303291542';
