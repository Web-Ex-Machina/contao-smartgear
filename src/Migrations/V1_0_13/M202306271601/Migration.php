...
{
    protected $name = 'Smargear update to v1.0.13';
    protected $description = 'Set Smartgear to version 1.0.13';
    protected $version = '1.0.13';
    protected $translation_key = 'WEMSG.MIGRATIONS.V1_0_13_M202306271601';
