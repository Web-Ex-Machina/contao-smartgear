...
namespace WEM\SmartgearBundle\Migrations\V1_0_32\M202405311133;
...
{
    protected $name = 'Smargear update to v1.0.32';
    protected $description = 'Set Smartgear to version 1.0.32';
    protected $version = '1.0.32';
    protected $translation_key = 'WEMSG.MIGRATIONS.V1_0_32_M202405311133';
